...
public class EdicionUsuario extends javax.swing.JFrame {
     ...
     * @param idUsuario
     */
    public EdicionUsuario(Controladora controladora, String nombreUsuario, int idUsuario) {
        initComponents();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        usu = controladora.traerUsuario(this.idUsuario);
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (nombreUsuario.isBlank() || contrasenia.isBlank()) {
            Mensajes.mostrar("error", "Error al Editar Usuario", "LLene todos los campos vacios", this);
        } else {
            controladora.editarUsuario(usu, nombreUsuario, contrasenia, rol);
            Mensajes.mostrar("info", "Usuario Editado", "Se edito correctamente", this);
